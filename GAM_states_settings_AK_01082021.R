...
gam_pooled <- gam(NumOutbreaks ~ s(Month, bs='cc', k=12)+CovidEra+REPORTINGSITE, data=All9States, family=poisson)
plot.gam(gam_pooled)
...
glm.summer<-glm(NumOutbreaks~CovidEra+REPORTINGSITE, data=All9States.summer, family=poisson)
summary(glm.summer)
